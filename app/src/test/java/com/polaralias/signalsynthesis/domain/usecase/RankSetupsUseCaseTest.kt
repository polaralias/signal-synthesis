...
class RankSetupsUseCaseTest {
    ...
    fun executeRanksByConfidenceAndSetsFields() {
        ...
        val sentimentData = mapOf(
            "AAA" to com.polaralias.signalsynthesis.domain.model.SentimentData(0.3, "Positive"),
            "BBB" to com.polaralias.signalsynthesis.domain.model.SentimentData(-0.1, "Neutral")
        )
        val contextData = mapOf(
            "AAA" to com.polaralias.signalsynthesis.domain.usecase.SymbolContext(null, null, sentimentData["AAA"]),
            "BBB" to com.polaralias.signalsynthesis.domain.usecase.SymbolContext(null, null, sentimentData["BBB"])
        )
